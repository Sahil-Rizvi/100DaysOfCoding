...
public class DayThirty {
    ...
    public static int editDistance2(String str1,String str2, int m, int n){
        var minLength = Math.min(m,n);
        var maxLength = Math.max(m,n);
        ...
        return dp[maxLength%2][minLength];
    }
    ...
    public void test(){
        ...
        System.out.println(editDistance2(str1,str2,str1.length(),str2.length()));
    }
